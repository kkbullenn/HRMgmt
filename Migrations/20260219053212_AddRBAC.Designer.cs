...
namespace HRMgmt.Migrations
{
    ...
    [Migration("20260219053212_AddRBAC")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HRMgmt.Models.Permission", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HRMgmt.Models.RolePermission", b =>
                {
            ...
            modelBuilder.Entity("HRMgmt.Models.RolePermission", b =>
                {
                    b.HasOne("HRMgmt.Models.Permission", "Permission")
                        .WithMany("RolePermissions")
                        .HasForeignKey("PermissionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("HRMgmt.Models.Role", "Role")
                        .WithMany("RolePermissions")
            ...
            modelBuilder.Entity("HRMgmt.Models.ShiftAssignment", b =>
                {
                    ...
                    b.HasOne("HRMgmt.Models.User", "User")
            ...
            modelBuilder.Entity("HRMgmt.Models.User", b =>
                {
                    b.HasOne("HRMgmt.Models.Role", "RoleNavigation")
                        .WithMany("Users")
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
